...
namespace syn {
  ...
  public:
    enum eExtiLevel {
      Exti_level_low = 0, Exti_edge_rise = 1, Exti_edge_fall = 2, Exti_edge_both = 3
    };
  ...
  public:
    ...
    void setDebounce(bool value) { // set debounce start valaue to high or low
      if (value)
        debounce_ = 0xA0;
      else
        debounce_ = 0;
  ...
  public:
    enum eClockOutSrc {
      Off = 0x00, HSIdiv = 0x01, LSI = 0x03, HSE = 0x05, HSI = 0x17, Master = 0x19, CPU = 0x09,
      CPU_2 = 0x0B, CPU_4 = 0x0D, CPU_8 = 0x0F, CPU_16 = 0x11, CPU_32 = 0x13, CPU_64 = 0x15
    };
  ...
  class Beeper {
  public:
    enum eFrequency { KHz1, KHz2, KHz4 };
  ...
  class SpiNC {
  public:
    enum eBaudrate { MHz8 = 0, MHz4 = 1, MHz2 = 2, MHz1 = 3, KHz500 = 4, KHz250 = 5, KHz125 = 6, KHz63 = 7 };
    ...
    static void transceive21(uint8_t* data) {
      while (!(SPI->SR & SPI_SR_TXE))
        ;
      SPI->DR = *data++;
      while (!(SPI->SR & SPI_SR_TXE))
  ...
  class Uart {
  public:
    enum eBaudrate { bd2400, bd9600, bd19200, bd57600, bd115200, bd232400, bd460800, bd921600 };
    enum eStopbits { sb1 = 0, sb1_5 = 3, sb2 = 10 };
