...
void SysTick_Handler(void) OS_TEXT_SECTION_ATTRIBUTE(SysTick_Handler);
...
#define OS_VERSION_GENERIC  50802u
...
//
// TLS support.
// May be defined in OSCHIP.h to generate equal task structure for different embOS versions, even when TLS is not supported
//
...
#endif
//
// Per default it is aszumed pointers need to be aligned to int.
// For some cores that is not necessary.
//
#ifndef   OS_ALIGN_PTR
...
#endif
//
// Defines whether the sembOS sources are built for embOS-MPU
//
...
//
  ...
  #define TRACE_RECORD_API_PTR(Id, Para0)                                    if (OS_Global.pTrace != NULL) {OS_Global.pTrace->pfRecordU32  ((Id) + OS_TRACE_API_OFFSET, OS_Global.pTrace->pfPtrToId((OS_U32)(Para0)));}                                                                      if ((Id) <= 255u) { OS_TRACE_Ptr   ((OS_U8)(Id), (Para0));                  }
  #define TRACE_RECORD_API_PTR_U32(Id, Para0, Para1)                         if (OS_Global.pTrace != NULL) {OS_Global.pTrace->pfRecordU32x2((Id) + OS_TRACE_API_OFFSET, OS_Global.pTrace->pfPtrToId((OS_U32)(Para0)), (OS_U32)(Para1));}                                                     if ((Id) <= 255u) { OS_TRACE_PtrU32((OS_U8)(Id), (Para0), (OS_U32)(Para1)); }
  #define TRACE_RECORD_API_PTR_U32X2(Id, Para0, Para1, Para2)                if (OS_Global.pTrace != NULL) {OS_Global.pTrace->pfRecordU32x3((Id) + OS_TRACE_API_OFFSET, OS_Global.pTrace->pfPtrToId((OS_U32)(Para0)), (OS_U32)(Para1), (OS_U32)(Para2));}                                    if ((Id) <= 255u) { OS_TRACE_PtrU32((OS_U8)(Id), (Para0), (OS_U32)(Para1)); }
  #define TRACE_RECORD_API_PTR_U32X3(Id, Para0, Para1, Para2, Para3)         if (OS_Global.pTrace != NULL) {OS_Global.pTrace->pfRecordU32x4((Id) + OS_TRACE_API_OFFSET, OS_Global.pTrace->pfPtrToId((OS_U32)(Para0)), (OS_U32)(Para1), (OS_U32)(Para2), (OS_U32)(Para3)); }                  if ((Id) <= 255u) { OS_TRACE_PtrU32((OS_U8)(Id), (Para0), (OS_U32)(Para1)); }
  #define TRACE_RECORD_API_PTR_U32X4(Id, Para0, Para1, Para2, Para3, Para4)  if (OS_Global.pTrace != NULL) {OS_Global.pTrace->pfRecordU32x5((Id) + OS_TRACE_API_OFFSET, OS_Global.pTrace->pfPtrToId((OS_U32)(Para0)), (OS_U32)(Para1), (OS_U32)(Para2), (OS_U32)(Para3), (OS_U32)(Para4)); } if ((Id) <= 255u) { OS_TRACE_PtrU32((OS_U8)(Id), (Para0), (OS_U32)(Para1)); }
...
OS_EXTERN OS_SADDR OS_TLS_PTR              OS_pTLS                          OS_BSS_SECTION_ATTRIBUTE(OS_pTLS);                          //lint !e9075 MISRA C:2012 Rule 8.4, required, Global pointer to thread local storage
#endif
#if (OS_CHECKSTACK == 2)
...
#else
OS_UINT OS_MAILBOX_GetMessageCnt   (const OS_MAILBOX* pMB)                                              OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_GetMessageCnt)    OS_SECURE_ATTRIBUTE;
#endif
...
void    OS_INT_EnableConditional(void) OS_TEXT_SECTION_ATTRIBUTE(OS_INT_EnableConditional);
...
*/
  ...
  OS_INTERWORK void OS_INT_PreserveAndDisableAllFunc(OS_U32 *pSave) OS_TEXT_SECTION_ATTRIBUTE(OS_INT_PreserveAndDisableAllFunc);
...
*/
#if (OS_SUPPORT_MPU != 0)
void                OS_MPU_AddRegion            (OS_TASK* pTask, OS_U32 BaseAddr, OS_U32 Size, OS_U32 Permissions, OS_U32 Attributes)                            OS_TEXT_SECTION_ATTRIBUTE(OS_MPU_AddRegion);
...
void                OS_MPU_ConfigMem            (OS_U32 ROM_BaseAddr, OS_U32 ROM_Size, OS_U32 RAM_BaseAddr, OS_U32 RAM_Size, OS_U32 OS_BaseAddr, OS_U32 OS_Size) OS_TEXT_SECTION_ATTRIBUTE(OS_MPU_ConfigMem);
...
void    OS_TICKLESS_Start          (OS_TIME Time, voidRoutine* Callback) OS_TEXT_SECTION_ATTRIBUTE(OS_TICKLESS_Start);
...
*/
#ifndef OS_LIBMODE_SAFE
void OS_STAT_AddLoadMeasurement  (int Period, OS_U8 AutoAdjust, OS_I32 DefaultMaxValue)                                              OS_TEXT_SECTION_ATTRIBUTE(OS_STAT_AddLoadMeasurement);
void OS_STAT_AddLoadMeasurementEx(int Period, OS_U8 AutoAdjust, OS_I32 DefaultMaxValue, void OS_STACKPTR* pStack, OS_UINT StackSize) OS_TEXT_SECTION_ATTRIBUTE(OS_STAT_AddLoadMeasurementEx);
